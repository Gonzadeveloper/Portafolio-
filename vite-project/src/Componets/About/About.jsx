    ...
    <div className="container containerAbout" id="About">
      <div className="row align-items-center">
        <div className="col-12 col-md-6">
          <img
            src="https://png.pngtree.com/thumb_back/fw800/background/20230720/pngtree-d-rendering-of-a-futuristic-office-with-green-wall-plants-and-image_3721525.jpg"
